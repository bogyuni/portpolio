CoolClock.config.skins = {
	...
	swissRail: {
		outerBorder:      { lineWidth: 2, radius: 95, color: "black", alpha: 0 },
		...
		hourHand:         { lineWidth: 6, startAt: 0, endAt: 40, color: "#0e57b3", alpha: 0.8 },
		minuteHand:       { lineWidth: 4, startAt: 0, endAt: 55, color: "#0e57b3", alpha: 0.8 },
		secondHand:       { lineWidth: 2, startAt: 0, endAt: 50,  color: "#000000", alpha: 0.6 },
		secondDecoration: { lineWidth: 10, startAt: 70, radius: 4, fillColor: "green", color: "red", alpha: 0 }
	},
